WebAPI Kurs 26. Januar - VC


Tag 1: (Vormittags)

- [ ]   Was ist Rest
- [x]   ASP.NET Grundlagen 
- [ ]   HTTP - Methoden + Erstes Beispiel -> Standard WheatherForcecast
- [x]   Das neue Konzept von ASP.NET 5 (Swagger)
- [x] Controller ohne HttpVerbs
